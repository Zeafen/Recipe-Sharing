...
/**
 * Composes section button
 * @param modifier Modifier applied to button
 * @param onClick called when user click on button
 * @param enabled if button is able to be clicked
 * @param border button border
 * @param shape button shape
 * @param colors button colors
 * @param title Title content
 * @param contentPadding button padding
 * @param supportingText Under title content
 * @param leadingIcon leading content
 * @param trailingIcon trailing content
 */
@Composable
fun SectionButton(
    onClick: () -> Unit,
